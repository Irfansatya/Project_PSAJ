        ...
        <div class="p-4 md:p-8">
          ...
          <div class="mb-6">
            ...
            <ul class="mt-2 space-y-2 text-gray-600">
              {[
                { text: "3 x 4 meter", icon: "src/assets/noun-house-7458210 1.png" },
          ...
          <div class="mb-6">
            ...
            <ul class="mt-2 space-y-2 text-gray-600">
              {[
                { text: "Tamu menginap dikenakan biaya", icon: "src/assets/image 8.png" },
                { text: "Tipe ini bisa diisi maks. 2 orang/kamar", icon: "src/assets/image-15.png" },
                { text: "Tidak untuk pasutri", icon: "src/assets/image-13.png" },
                { text: "Tidak boleh membawa anak", icon: "src/assets/image-14.png" }
              ].map((item) => (
    ...
    <div class="grid grid-cols-4 gap-6">
      ...
      <div class="mb-6">
          ...
          <div class="mt-4">
              ...
              <button class="px-4 py-2 bg-gray-200 rounded-lg ml-2">Transportasi</button>
          </div>
          <ul class="mt-10 space-y-2 text-gray-600">
              {[
                  ...
                  { icon: "image 13.png", text: "Universitas Gadjah Mada 1.3 km" },
                  { icon: "image 14.png", text: "RS DKT 1.3 km" }
              ].map((item) => (
                  <li class="flex items-center gap-2">
                      <img src={`src/assets/${item.icon}`} alt="icon" class="w-5 my-2 h-5" />
                      {item.text}
                  </li>
              ))}
          </ul>
      ...
      <div class="mb-6">
          ...
          <p class="text-gray-500 text-sm">Biaya DP adalah 30% dari biaya yang dipilih</p>
          <div class="mt-4 grid grid-cols-2 gap-2 text-gray-600">
              {[
                  { icon: "image 15.png", text: "Waktu mulai kos terdekat: Bisa hari H setelah pengajuan sewa" },
                  { icon: "image 15.png", text: "Waktu mulai kos terjauh: setelah 1 bulan pengajuan sewa" }
              ].map((item) => (
                  <div class="flex items-center gap-2">
                      <img src={`src/assets/${item.icon}`} alt="icon" class="w-5 h-5" />
                      {item.text}
                  </div>
              ))}
          </div>
      ...
      >
        ...
        {showNota() && (
          <div class="mt-4 p-4 border rounded-lg bg-gray-50">
            ...
            <div class="flex justify-between text-sm mt-1">
              ...
              <span>Rp{(harga() / 2).toLocaleString()}</span>
            </div>
        ...
        <div class="mt-4 flex flex-col gap-2">
          ...
          <button 
            class="w-full bg-red-500 text-white p-2 rounded-lg"
      ...
      {showPopup() && (
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            <h2 class="text-lg font-semibold">Detail estimasi pembayaran</h2>
            <p class="mt-2 text-sm text-gray-600">Pembayaran Pertama (DP): Rp{(harga() / 2).toLocaleString()}</p>
            <p class="text-sm text-gray-600">Pembayaran Selanjutnya: Rp{harga().toLocaleString()}</p>

            <div class="mt-4 flex justify-end gap-2">
              <button class="px-4 py-2 text-gray-500" onClick={() => setShowPopup(false)}>Batal</button>
              <button class="px-4 py-2 bg-red-500 text-white rounded-lg" onClick={handleConfirm}>Konfirmasi</button>
            </div>
          </div>
        </div>
      )}
